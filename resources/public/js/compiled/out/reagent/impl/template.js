...
goog.require('module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index');
...
var G__21612 = o;
goog.object.set(G__21612,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__21613__delegate = function (args){
...
return G__21613__delegate.call(this,args);};
G__21613.cljs$lang$maxFixedArity = 0;
G__21613.cljs$lang$applyTo = (function (arglist__21615){
var args = cljs.core.seq(arglist__21615);
return G__21613__delegate(args);
});
...
var G__21616 = o;
goog.object.set(G__21616,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21620 = props;
var G__21620__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21620,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21620);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21620__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__3922__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__21621 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21621,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__21621;
}
})(),id_class);
...
var G__21622 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21622) {
case (0):
return module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].createElement(component,jsprops);

break;
case (1):
return module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].createElement(component,jsprops,reagent.impl.protocols.as_element.call(null,this$,cljs.core.nth.call(null,argv,first_child,null)));

break;
default:
return module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21622){
...
reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){
return cljs.core._write.call(null,writer__4162__auto__,"reagent.impl.template/HiccupTag");
});
...
var vec__21624 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21624,(0),null);
var id = cljs.core.nth.call(null,vec__21624,(1),null);
var className = cljs.core.nth.call(null,vec__21624,(2),null);
...
var temp__5808__auto___21627 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___21627 == null)){
} else {
var key_21628 = temp__5808__auto___21627;
jsprops.key = key_21628;
}

return module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].createElement(c,jsprops);
});
...
var temp__5808__auto___21629 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___21629 == null)){
} else {
var key_21630 = temp__5808__auto___21629;
jsprops.key = key_21630;
}

return module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].createElement(reagent.impl.component.functional_render_fn.call(null,compiler,tag),jsprops);
});
/**
...
var jsprops = (function (){var or__3922__auto__ = reagent.impl.template.convert_prop_value.call(null,((hasprops)?props:null));
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return ({});
...
var temp__5808__auto___21631 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___21631 == null)){
} else {
var key_21632 = temp__5808__auto___21631;
jsprops.key = key_21632;
}

return reagent.impl.protocols.make_element.call(null,compiler,argv,module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].Fragment,jsprops,first_child);
});
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_.call(null,props)));
var jsprops = (function (){var or__3922__auto__ = reagent.impl.template.convert_props.call(null,((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return ({});
...
var input_class = (function (){var or__3922__auto__ = compiler.reagentInput;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
var temp__5808__auto___21633 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___21633 == null)){
} else {
var key_21634 = temp__5808__auto___21633;
jsprops.key = key_21634;
}
...
var jsprops = (function (){var or__3922__auto__ = props;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return ({});
...
var temp__5808__auto___21635 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___21635 == null)){
} else {
var key_21636 = temp__5808__auto___21635;
jsprops.key = key_21636;
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__21637_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__21637_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21638 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21638,(0),null);
var derefed = cljs.core.nth.call(null,vec__21638,(1),null);
...
break;
default:
var G__21643 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__21644 = compiler;
v = G__21643;
compiler = G__21644;
continue;
...
if(typeof reagent.impl.template.t_reagent$impl$template21648 !== 'undefined'){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21648 = (function (opts,id,fn_to_element,parse_fn,meta21649){
this.opts = opts;
this.id = id;
...
reagent.impl.template.t_reagent$impl$template21648.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (id,fn_to_element,parse_fn){
return (function (_21650,meta21649__$1){
var self__ = this;
var _21650__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21648(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21649__$1));
});})(id,fn_to_element,parse_fn))
;

reagent.impl.template.t_reagent$impl$template21648.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (id,fn_to_element,parse_fn){
return (function (_21650){
var self__ = this;
var _21650__$1 = this;
return self__.meta21649;
});})(id,fn_to_element,parse_fn))
;

reagent.impl.template.t_reagent$impl$template21648.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL;

reagent.impl.template.t_reagent$impl$template21648.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = ((function (id,fn_to_element,parse_fn){
...
reagent.impl.template.t_reagent$impl$template21648.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = ((function (id,fn_to_element,parse_fn){
...
reagent.impl.template.t_reagent$impl$template21648.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = ((function (id,fn_to_element,parse_fn){
...
reagent.impl.template.t_reagent$impl$template21648.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = ((function (id,fn_to_element,parse_fn){
...
reagent.impl.template.t_reagent$impl$template21648.getBasis = ((function (id,fn_to_element,parse_fn){
return (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21649","meta21649",-1465278340,null)], null);
});})(id,fn_to_element,parse_fn))
;

reagent.impl.template.t_reagent$impl$template21648.cljs$lang$type = true;

reagent.impl.template.t_reagent$impl$template21648.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21648";

reagent.impl.template.t_reagent$impl$template21648.cljs$lang$ctorPrWriter = ((function (id,fn_to_element,parse_fn){
return (function (this__4161__auto__,writer__4162__auto__,opt__4163__auto__){
return cljs.core._write.call(null,writer__4162__auto__,"reagent.impl.template/t_reagent$impl$template21648");
});})(id,fn_to_element,parse_fn))
;

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21648.
 */
reagent.impl.template.__GT_t_reagent$impl$template21648 = ((function (id,fn_to_element,parse_fn){
return (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21648(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21649){
return (new reagent.impl.template.t_reagent$impl$template21648(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21649));
});})(id,fn_to_element,parse_fn))
;

}

return (new reagent.impl.template.t_reagent$impl$template21648(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1744996257549
