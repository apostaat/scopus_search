...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__21603){
...
var on_write = cljs.core.get.call(null,map__21604__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(((!((((node === document.activeElement)) && (reagent.impl.input.has_selection_api_QMARK_.call(null,node.type)) && (typeof rendered_value === 'string') && (typeof dom_value === 'string')))) || (reagent.impl.input._STAR_force_set_dom_value_STAR_))){
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21604,map__21604__$1,on_write){
return (function (){
var _STAR_force_set_dom_value_STAR_21606 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
reagent.impl.input._STAR_force_set_dom_value_STAR_ = true;

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR_21606;
}});})(node_value,map__21604,map__21604__$1,on_write))
);
} else {
...
this$.reagentRefFn = ((cljs.core.fn_QMARK_.call(null,original_ref_fn))?((function (v,value,on_change,original_ref_fn){
return (function (el){
this$.inputEl = el;

return original_ref_fn.call(null,el);
});})(v,value,on_change,original_ref_fn))
:(cljs.core.truth_((function (){var and__3911__auto__ = original_ref_fn;
if(cljs.core.truth_(and__3911__auto__)){
return original_ref_fn.hasOwnProperty("current");
} else {
return and__3911__auto__;
}
})())?((function (v,value,on_change,original_ref_fn){
return (function (el){
this$.inputEl = el;
...
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__21607_SHARP_);
});})(v,value,on_change,original_ref_fn))
;
...
//# sourceMappingURL=input.js.map?rel=1744996257420
