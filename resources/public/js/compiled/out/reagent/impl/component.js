...
var temp__5806__auto__ = p.argv;
if((temp__5806__auto__ == null)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].Children.toArray(p.children));
} else {
var v = temp__5806__auto__;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__21564 = c;
var G__21564__$1 = (((G__21564 == null))?null:G__21564.prototype);
if((G__21564__$1 == null)){
return null;
} else {
return G__21564__$1.reagentRender;
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__21566 = c;
var G__21566__$1 = (((G__21566 == null))?null:G__21566.prototype);
if((G__21566__$1 == null)){
return null;
} else {
return G__21566__$1.render;
}
})() == null))));
});
...
while (G__21570__i < G__21570__a.length) {G__21570__a[G__21570__i] = arguments[G__21570__i + 0]; ++G__21570__i;}
  args = new cljs.core.IndexedSeq(G__21570__a,0,null);
} 
...
var or__3922__auto__ = (function (){var G__21575 = c;
var G__21575__$1 = (((G__21575 == null))?null:G__21575.constructor);
if((G__21575__$1 == null)){
return null;
} else {
return G__21575__$1.displayName;
}
})();
...
var G__21576 = c;
var G__21576__$1 = (((G__21576 == null))?null:G__21576.constructor);
if((G__21576__$1 == null)){
return null;
} else {
return G__21576__$1.name;
}
}
});
...
var _STAR_current_component_STAR_21577 = reagent.impl.component._STAR_current_component_STAR_;
reagent.impl.component._STAR_current_component_STAR_ = c;

try{return reagent.impl.component.wrap_render.call(null,c,compiler);
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_21577;
}});
...
return ((function (G__21578,G__21578__$1){
...
var c = this;
var G__21583_21585 = goog.object.get(c,"cljsRatom");
if((G__21583_21585 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__21583_21585);
}
...
var renders_21586 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21587 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_21586));
...
if((cljs.core.count.call(null,renders_21586) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_21586))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_21587)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_21587))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name = (function (){var or__3922__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = reagent.impl.util.fun_name.call(null,render_fun);
...
var G__21588 = o;
goog.object.set(G__21588,cljs.core.name.call(null,k),v);
...
var this$ = this;
module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].Component.call(this$,props,context,updater);
...
;
goog.object.extend(cmp.prototype,module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].Component.prototype,methods$);
...
goog.object.extend(cmp,module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].Component,static_methods);
...
var temp__5806__auto__ = reagent.impl.component.cached_react_class.call(null,compiler,tag);
if((temp__5806__auto__ == null)){
...
return (function() { 
var G__21589__delegate = function (args){
return reagent.impl.protocols.as_element.call(null,compiler,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
...
while (G__21590__i < G__21590__a.length) {G__21590__a[G__21590__i] = arguments[G__21590__i + 0]; ++G__21590__i;}
  args = new cljs.core.IndexedSeq(G__21590__a,0,null);
} 
return G__21589__delegate.call(this,args);};
G__21589.cljs$lang$maxFixedArity = 0;
G__21589.cljs$lang$applyTo = (function (arglist__21591){
var args = cljs.core.seq(arglist__21591);
return G__21589__delegate(args);
});
...
var _STAR_current_component_STAR_21594 = reagent.impl.component._STAR_current_component_STAR_;
reagent.impl.component._STAR_current_component_STAR_ = c;

try{return reagent.impl.component.functional_wrap_render.call(null,compiler,c);
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_21594;
}});
...
var vec__21595 = module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].useState((0));
var _ = cljs.core.nth.call(null,vec__21595,(0),null);
var update_count = cljs.core.nth.call(null,vec__21595,(1),null);
var state_ref = module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].useRef();
var ___$1 = (cljs.core.truth_(state_ref.current)?null:(function (){var obj = ({});
obj.forceUpdate = ((function (obj,argv,tag,vec__21595,_,update_count,state_ref){
return (function (){
return update_count.call(null,cljs.core.inc);
});})(obj,argv,tag,vec__21595,_,update_count,state_ref))
;
...
module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].useEffect(((function (argv,tag,vec__21595,_,update_count,state_ref,___$1,reagent_state,rat){
return (function reagent$impl$component$functional_render_$_mount(){
return ((function (argv,tag,vec__21595,_,update_count,state_ref,___$1,reagent_state,rat){
return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
var G__21598 = goog.object.get(reagent_state,"cljsRatom");
if((G__21598 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_.call(null,G__21598);
}
});
;})(argv,tag,vec__21595,_,update_count,state_ref,___$1,reagent_state,rat))
});})(argv,tag,vec__21595,_,update_count,state_ref,___$1,reagent_state,rat))
,[]);
...
if((rat == null)){
return reagent.ratom.run_in_reaction.call(null,((function (argv,tag,vec__21595,_,update_count,state_ref,___$1,reagent_state,rat){
return (function (){
...
var and__3911__auto__ = reagent.impl.util._STAR_always_update_STAR_ === false;
...
var or__3922__auto__ = reagent.impl.component.cached_react_class.call(null,compiler,tag);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var f = ((function (or__3922__auto__){
...
var f__$1 = module$Users$artemapostatov$work$wp_test$scopus_search$node_modules$react$index["default"].memo(f,reagent.impl.component.functional_render_memo_fn);
...
//# sourceMappingURL=component.js.map?rel=1744996257359
