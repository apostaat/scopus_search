...
return (new CustomEvent(event_name,(function (){var obj29224 = {"detail":data};
return obj29224;
})()));
} else {
...
var f = (function (){var pred__29231 = cljs.core._EQ_;
var expr__29232 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29231.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29232))){
return ((function (pred__29231,expr__29232){
return (function (p1__29225_SHARP_){
return console.warn(p1__29225_SHARP_);
});
;})(pred__29231,expr__29232))
} else {
if(cljs.core.truth_(pred__29231.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29232))){
return ((function (pred__29231,expr__29232){
return (function (p1__29226_SHARP_){
return console.debug(p1__29226_SHARP_);
});
;})(pred__29231,expr__29232))
} else {
if(cljs.core.truth_(pred__29231.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29232))){
return ((function (pred__29231,expr__29232){
return (function (p1__29227_SHARP_){
return console.error(p1__29227_SHARP_);
});
;})(pred__29231,expr__29232))
} else {
return ((function (pred__29231,expr__29232){
return (function (p1__29228_SHARP_){
return console.log(p1__29228_SHARP_);
});
;})(pred__29231,expr__29232))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29235){
...
var opts = map__29236__$1;
var eval_fn = cljs.core.get.call(null,map__29236__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29238_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29240,(0),null);
var v = cljs.core.nth.call(null,vec__29240,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1744996267049
