...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__26419){
...
var interceptor = map__26420__$1;
var id = cljs.core.get.call(null,map__26420__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
return cljs.core.swap_BANG_.call(null,re_frame.settings.store,cljs.core.update,new cljs.core.Keyword(null,"global-interceptors","global-interceptors",-1995759472),((function (map__26420,map__26420__$1,interceptor,id){
...
});})(map__26420,map__26420__$1,interceptor,id))
);
});
...
return cljs.core.into.call(null,re_frame.interop.empty_queue,cljs.core.remove.call(null,(function (p1__26422_SHARP_){
return cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__26422_SHARP_));
}),global_interceptors));
}));
});
...
//# sourceMappingURL=settings.js.map?rel=1744996261968
